...
impl Mouse {
    pub fn new() -> Mouse {
        Mouse {
            ...
            position_delta: Point2::new(0.0, 0.0),
            pressed_buttons: HashSet::new(),
            scroll_diff: 0.0,
        }
    }

    pub fn position_delta(&self) -> [f32; 2] {
        self.position_delta.into()
    }
    ...
    pub fn set_position(&mut self, x: u32, y: u32) {
        ...
        self.position_delta.x += x as f32;
        self.position_delta.y += y as f32;
    }
