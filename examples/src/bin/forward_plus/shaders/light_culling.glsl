...
layout (constant_id = 1) const ivec2 TILE_NUMS = vec2(0, 0);
layout (constant_id = 2) const ivec2 VIEWPORT_SIZE = vec2(0, 0);
...
layout(std430, set = 0, binding = 0) uniform TileLightVisiblities
{
