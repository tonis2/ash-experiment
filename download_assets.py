...
ASSET_GENERAL_TEXTURE_PATH = "./examples/assets/texture.jpg"
ASSET_CHALET_TEXTURE_PATH  = "./examples/assets/chalet.jpg"
ASSET_CHALET_OBJ_ZIP_PATH  = "./examples/assets/chalet.obj.zip"
...
zip.extractall("./examples/assets/")
zip.close()
